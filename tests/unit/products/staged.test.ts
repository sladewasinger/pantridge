...
it.each(['lookup', undefined])(
  'returns OFF details without AI for stage %s, then refines cached data',
  async (stage) => {
    ...
    const raw = await resolveProduct('owner', JSON.stringify({ barcode: '3017620422003', stage }));
