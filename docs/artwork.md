...
The library includes 103 food illustrations (36 fridge, 57 pantry, 10 freezer), 11 plain packaging illustrations, six household illustrations, and 18 drink illustrations (138 total). This is a curated collection of common US groceries, not a statistical popularity ranking. Categories organize the picker; they are not food storage advice. Apple, bananas, orange, lemon and lime appear under Pantry; cucumber and zucchini remain under Fridge. Asset paths remain stable even when browsing categories change. Adding artwork does not create inventory.
...
The Drinks category includes beer bottles and cans, red/white/rosé/sparkling wine, whiskey, vodka, gin, rum, tequila, brandy, green and yellow Chartreuse, liqueur, hard cider, vermouth, and mezcal. Packaging includes plain amber, green, and clear glass bottles with blank labels. Drink aliases are shared across name matching, picker search, and classifier metadata: bourbon/whisky select whiskey, for example, while yellow Chartreuse overrides the default green match. No inventory or expiration estimates are added by this artwork expansion.

Red onion, raspberries, and a large Tabasco Original Red bottle have dedicated SVGs. The bottle uses the red cap, long neck, glass body and green-bordered diamond label from the [manufacturer’s product reference](https://www.tabasco.com/products/hot-sauces/original-red-sauce/). These choices participate in name matching, picker search and classifier metadata. One-time shopping rows preview matching artwork without creating an inventory identity. Existing onion, berry and hot-sauce freshness profiles are reused.

## Maintenance

- Author food and packaging recipes in `scripts/artwork/catalog.mjs` and drink recipes in `scripts/artwork/drinks.mjs`; silhouettes and package motifs live in the adjacent small modules.
