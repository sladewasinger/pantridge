...
- The underground Cellar continues below the kitchen floor and displays all stocked items, with unspecified items first and small location badges. Keep its progressive loading accessible. Nonfood supplies use the unspecified location and household artwork.
